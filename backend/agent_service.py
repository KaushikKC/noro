...
class AgentService:
    ...
    def __init__(self):
        ...
        if AGENTS_AVAILABLE:
            try:
                ...
                self.orchestrator = PredictXOrchestrator(
                    llm_provider="openai",  # Can be overridden via env
                    model_name="gpt-4o"
                )
    ...
    async def full_analysis(self, market_question: str, market_id: str = None) -> Dict[str, Any]:
        """
        Run full analysis pipeline (analyzer + trader)
        ...
        if not self.orchestrator:
            return {
                ...
                "trade_proposal": {
                    ...
                    "amount": 100.0,
                    "confidence": 0.3,
                    "reasoning": "Agents not available"
                }
            }
